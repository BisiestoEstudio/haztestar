...
const PLUGIN_NAME = 'haztestar-core';
const PLUGIN_DIR = (WP_PLUGIN_DIR . '/' . PLUGIN_NAME . '/' );      // Slash at the end
const PLUGIN_URL = (WP_PLUGIN_URL . '/' . PLUGIN_NAME . '/' );      // Slash at the end
